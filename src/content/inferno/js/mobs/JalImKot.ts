...
export const MeleerModel = Assets.getAssetUrl("models/7697_33010.glb");
...
export class JalImKot extends Mob {
  ...
  endDig() {
    // The target can vanish during the 6-tick dig - startDig guards this, but aggro can be
    // nulled between the two. The surface still happens (digLocation was fixed at startDig);
    // only the interrupt-combat courtesy has nobody to apply to.
